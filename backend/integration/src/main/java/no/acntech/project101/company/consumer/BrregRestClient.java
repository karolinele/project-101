...
public class BrregRestClient {
    ...
    public String lookupOrgName(final String organisasjonsnummer) {
        System.out.println();
        final URI uri = getUriOrganization(organisasjonsnummer);
    ...
    private URI getUriOrganization(String organisasjonsnummer) {
